    ...
    if (props.title === "menu1") {
        content = (
            <div>
                <hr id={styles.bold} />
                <div id={styles.tag}>
                    <span className={styles.tag-content} id={styles.order}>순서</span>
                    <span className={styles.tag-content} id={styles.title}>제목</span>
                    <span className={styles.tag-content} id={styles.author}>작성자</span>
                    <span className={styles.tag-content} id={styles.date}>작성일</span>
                </div>
                ...
                {posts.length === 0 ? (
                    ...
                    <ul>
                        {posts.map(post => (
                            <li key={post.id}>
                                <span className={styles.post-content} id={styles.order}>{post.id}</span>
                                <span className={styles.post-content} id={styles.title}>{post.title}</span>
                                <span className={styles.post-content} id={styles.author}>{post.author}</span>
                                <span className={styles.post-content} id={styles.date}>{post.createdAt}</span>
                                <span id={styles.wrap}>
